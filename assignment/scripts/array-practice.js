...
let foodArray = ['Chinese', 'Pizza', 'Prime Rib', 'BBQ'];

// 1.b. TODO: Log your array of foods to the console with a message, similar
//      to the example above
console.log('Some of my favorie foods are: ', foodArray);
...
console.log('The last animal is:', last = animalArray[animalArray.length - 1]);
...
foodArray.unshift('Spiral cut ham');
